...
class Autoscout24SpiderMiddleware:
...
class Autoscout24DownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADER_ENDPOINT', 'https://headers.scrapeops.io/v1/browser-headers?api_key=c0c3578d-38f3-4593-8bac-7ea35c42e256&num_headers=50') 
